...
export function useMerchants() {
  ...
  const deleteMerchant = async (merchantId: string) => {
      try {
          ...
          // Get all users for this merchant (to clean up their wallets)
          await supabase
          ...
          // Delete machines (unassign or delete)
          await supabase.from('machines').delete().eq('merchant_id', merchantId);
          
          // Delete withdrawals related to this merchant
          await supabase.from('withdrawals').delete().eq('merchant_id', merchantId);
          
          // Delete submission_reviews related to this merchant
