...
onMounted(() => {
  fetchInitialData(); // Initial load (shows spinner)
  
  // Refresh live feeds every 60s
  setInterval(() => {
...
.animate-scroll-vertical {
  /* Only animate if content is taller than container. 
     For now, we rely on standard overflow or manual scroll for stability 
     unless you strictly want marquee effect. 
     Uncomment below for marquee: */
